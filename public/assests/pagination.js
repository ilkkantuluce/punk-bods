...
if(document.getElementsByClassName("underwear")[0].innerHTML == ''){
	document.getElementsByClassName("underwear-wrap")[0].style.display = 'none';
}
if(document.getElementsByClassName("outerwear")[0].innerHTML == ''){
	document.getElementsByClassName("outerwear-wrap")[0].style.display = 'none';
}
if(document.getElementsByClassName("bottom")[0].innerHTML == ''){
	document.getElementsByClassName("bottom-wrap")[0].style.display = 'none';
}
if(document.getElementsByClassName("item")[0].innerHTML == ''){
	document.getElementsByClassName("item-wrap")[0].style.display = 'none';
}
if(document.getElementsByClassName("socks")[0].innerHTML == ''){
	document.getElementsByClassName("socks-wrap")[0].style.display = 'none';
}
if(document.getElementsByClassName("top")[0].innerHTML == '' && document.getElementsByClassName("underwear")[0].innerHTML == '' && document.getElementsByClassName("outerwear")[0].innerHTML == '' && document.getElementsByClassName("bottom")[0].innerHTML == '' && document.getElementsByClassName("item")[0].innerHTML == '' && document.getElementsByClassName("socks")[0].innerHTML == ''){
